...
public:
    ...
    virtual void RenderSceneCB()
    {
        ...
        sl[1].Attenuation.Linear = 0.3f;
        sl[1].Cutoff = 2.0f; //size
        ...
        p.SetPerspectiveProj(10.0f, WINDOW_WIDTH, WINDOW_HEIGHT, 1.0f, 1000.0f);
    ...
    virtual void SpecialKeyboardCB(int Key, int x, int y)
    {
        ...
        case GLUT_KEY_F3:
            ...
            //увеличить рассеяное освещение
        case GLUT_KEY_F4:
            m_directionalLight.DiffuseIntensity += 0.05f;
            break;

            //уменьшить рассеяное освещение
        case GLUT_KEY_F5:
            m_directionalLight.DiffuseIntensity -= 0.05f;
            break;
        }
